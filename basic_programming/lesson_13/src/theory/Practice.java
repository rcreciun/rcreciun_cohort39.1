...
public class Practice {
    ...
    public static void main(String[] args) {
        ...
        // Разработайте метод void, который в качестве аргумена принимает целое число и проверяет, является ли п
        // ереданное ему число четным, и выводит соответствующее сообщение.
        if (number % 2 == 0) {
