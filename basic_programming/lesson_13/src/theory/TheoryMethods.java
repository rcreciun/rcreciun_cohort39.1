...
public class TheoryMethods {
     ...
     * <p> Parameter List – перечень параметров представлен типом, порядком и количеством параметров метода.
     * Данная опция задается произвольно, в методе может присутствовать нулевой параметр.
     * <p> method body – тело метода определяет метод работы с командами.
     * <p>
